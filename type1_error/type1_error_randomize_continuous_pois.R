...
generate.data.norm <- function(number.of.seeds, sample.size, AA, BB, r, ef){
  ...
  order.table$num1_pois <- qpois(order.table$num1_uni, lambda=2) +ef
...
saveRDS(case1, paste0("/projectnb/cbs/samalate/RDS/type1/results/type1_pois",A,"_", B, "_", r,"_", n, ".rds"))
